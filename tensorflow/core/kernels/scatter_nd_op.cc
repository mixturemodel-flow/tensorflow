...
TF_CALL_GPU_ALL_TYPES_NO_HALF(REGISTER_SCATTER_ND_ADD_SUB_GPU);
TF_CALL_GPU_ALL_TYPES_NO_HALF(REGISTER_SCATTER_ND_UPDATE_GPU);

TF_CALL_GPU_ALL_TYPES_NO_HALF(REGISTER_SCATTER_ND_GPU);
...
TF_CALL_GPU_ALL_TYPES_NO_HALF(DECLARE_GPU_SPECS);
