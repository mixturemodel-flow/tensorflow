...
TF_CALL_GPU_ALL_TYPES_NO_HALF(REGISTER_SCATTER_ARITHEMTIC_GPU);
TF_CALL_GPU_ALL_TYPES_NO_HALF(REGISTER_SCATTER_UPDATE_GPU);
...
TF_CALL_GPU_ALL_TYPES_NO_HALF(REGISTER_SCATTER_ARITHEMTIC_SYCL);
TF_CALL_GPU_ALL_TYPES_NO_HALF(REGISTER_SCATTER_UPDATE_SYCL);
